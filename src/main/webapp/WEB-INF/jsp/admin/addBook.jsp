...
<div class="main-context">
    <div class="l-title row">
        <div class="col-lg-3"><span > <span class="glyphicon glyphicon-home"
                                            aria-hidden="true"></span> <a href="${pageContext.request.contextPath}/admin/allBook" style="text-decoration: none;color: black">图书目录</a></span><span style="color: rgb(119,119,139)"> > 添加图书</span></div>
    </div>

    <div class="alert-book">

        <div class="row">
            <div class="col-lg-10 col-lg-offset-3 h1" style="font-weight: 700"> 请输入书籍信息</div>
        </div>
        <form class="form-horizontal" action="${pageContext.request.contextPath}/admin/finishAddBook">
            <div class="form-group form-margin">
                <label for="input1" class="col-sm-1 control-label">图书名称:</label>
                <div class="col-sm-7">
                    <input type="text" class="form-control" id="input1" placeholder="请输入书名" name="bookName" required="required">
                </div>
            </div>
            <div class="form-group form-margin">
                <label for="input2" class="col-sm-1 control-label">作者</label>
                <div class="col-sm-7">
                    <input type="text" class="form-control" id="input2" placeholder="请输入作者" name="author" required="required">
                </div>
            </div>
            <div class="form-group form-margin">
                <label for="input3" class="col-sm-1 control-label">出版社</label>
                <div class="col-sm-7">
                    <input type="text" class="form-control" id="input3" placeholder="请输入出版社名" name="publisher" required="required">
                </div>
            </div>
            <div class="form-group form-margin">
                <label for="input4" class="col-sm-1 control-label">总量</label>
                <div class="col-sm-7">
                    <input type="text" class="form-control" id="input4" placeholder="请输入书籍总量" name="totalNum" required="required">
                </div>
            </div>
            <div class="form-group form-margin">
                <label for="input5" class="col-sm-1 control-label">剩余量</label>
                <div class="col-sm-7">
                    <input type="text" class="form-control" id="input5" placeholder="请输入书籍剩余量" name="surplusNum" required="required">
                </div>
            </div>
            <div class="form-group" style="margin-top: 50px">
                <div class="col-sm-offset-3 col-sm-3" >
                    <button type="submit" class="btn btn-success" style="width: 150px;font-weight: 700;font-size: 18px">   提交添加  </button>
                </div>
            </div>
