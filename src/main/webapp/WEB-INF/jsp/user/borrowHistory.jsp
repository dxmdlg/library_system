...
<aside class="aside-left">
    <section>
        ...
        <ul class="siderbar-menu">
            ...
            <li class="list-li active-left"><a href="${pageContext.request.contextPath}/user/borrowHistory" class="a"><span class="glyphicon glyphicon-time"
...
<div class="main-context">
    <div class="row l-title">
        <div class="col-lg-3"><span > <span class="glyphicon glyphicon-home"
                                            aria-hidden="true"></span> <a href="${pageContext.request.contextPath}/user/borrowHistory" style="text-decoration: none;color: black">借阅记录</a></span><span style="color: rgb(119,119,139)"> > 借阅记录</span></div>
    </div>
    ...
    <div class="show-table" style="box-shadow: 0 4px 12px rgb(0 0 0);">
        ...
        <div class="page-nav"><nav aria-label="Page navigation"><ul class="pagination">
            ...
            <c:forEach begin="1" end="${borrowPage.pages}" var="i">
                <li><a href="${pageContext.request.contextPath}/user/borrowHistory?pn=${i}">${i}</a></li>
            </c:forEach>
